...
function ihacklog_pkg_parsemedia($atts, $content=null) {
    ...
    if($flv = ihacklog_pkg_parseflv($content, $width, $height)) {
		...
		switch($type) {
			...
			case 'flv':
				return '<script type="text/javascript" reload="1">document.write(AC_FL_RunContent(\'width\', \''.$width.'\', \'height\', \''.$height.'\', \'allowNetworking\', \'internal\', \'allowScriptAccess\', \'never\', \'src\', \''.plugin_dir_url(HACKLOG_PACKAGE_LOADER ) .'swf/flvplayer.swf\', \'flashvars\', \'file='.rawurlencode($url).'\', \'quality\', \'high\', \'wmode\', \'transparent\', \'allowfullscreen\', \'true\'));</script>';
			case 'swf':
			...
			case 'gallery':
				$url=$post->ID;
				return '<script type="text/javascript" reload="1">document.write(AC_FL_RunContent(\'width\', \''.$width.'\', \'height\', \''.$height.'\', \'allowNetworking\', \'internal\', \'allowScriptAccess\', \'never\', \'src\', \''.plugin_dir_url(HACKLOG_PACKAGE_LOADER ) .'imagerotator/imagerotator.swf\', \'flashvars\', \'file='.rawurlencode(plugin_dir_url(HACKLOG_PACKAGE_LOADER ) .'imagerotator/playlist.php?id='.$url.'&width='.$width.'&height='.$height. '&size=' .$size ).'\', \'quality\', \'high\', \'wmode\', \'transparent\', \'allowfullscreen\', \'true\'));</script>';
			default:
